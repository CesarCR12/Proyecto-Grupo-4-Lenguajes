...
INSERT INTO FIDE_CLIENTES_TB (ID_CLIENTE, ID_PAIS, ID_PROVINCIA, ID_CANTON, ID_DISTRITO, ID_ESTADOS, NOMBRE, CORREO, DIRECCION, TELEFONO) 
VALUES ('1', 'CR', 'SJ', 'ES', 'SAN', '1', 'Cesar', 'Cesar@example.com', 'Calle 123', '87026789');
INSERT INTO FIDE_CLIENTES_TB (ID_CLIENTE, ID_PAIS, ID_PROVINCIA, ID_CANTON, ID_DISTRITO, ID_ESTADOS, NOMBRE, CORREO, DIRECCION, TELEFONO) 
VALUES ('2', 'CR', 'AL', 'AT', 'ME', '1', 'Esteban', 'Esteban@example.com', 'Avenida 456', '85643567');
INSERT INTO FIDE_CLIENTES_TB (ID_CLIENTE, ID_PAIS, ID_PROVINCIA, ID_CANTON, ID_DISTRITO, ID_ESTADOS, NOMBRE, CORREO, DIRECCION, TELEFONO) 
VALUES ('3', 'CR', 'CA', 'PA', 'OR', '1', 'Alexandra', 'Alexandra@example.com', 'Calle 789', '88456789');
COMMIT;
...
DELETE FROM FIDE_DETALLES_FACTURAS_TB WHERE ID_DETALLE = '1';
DELETE FROM FIDE_DETALLES_FACTURAS_TB WHERE ID_DETALLE = '2';
DELETE FROM FIDE_DETALLES_FACTURAS_TB WHERE ID_DETALLE = '3';
DELETE FROM FIDE_DETALLES_FACTURAS_TB WHERE ID_DETALLE = '4';
