...
CREATE OR REPLACE PROCEDURE FIDE_CLIENTES_TB_INSERTAR_CLIENTE_SP (
    ...
    V_ID_PAIS IN VARCHAR2,
    V_ID_PROVINCIA IN VARCHAR2,
    V_ID_CANTON IN VARCHAR2,
    V_ID_DISTRITO IN VARCHAR2
) AS
BEGIN
    INSERT INTO FIDE_CLIENTES_TB (NOMBRE, CORREO, CONTRASEÑA, TELEFONO, DIRECCION, ID_PAIS, ID_PROVINCIA, ID_CANTON, ID_DISTRITO)
    VALUES (V_NOMBRE, V_CORREO, V_CONTRASEÑA, V_TELEFONO, V_DIRECCION, V_ID_PAIS, V_ID_PROVINCIA, V_ID_CANTON, V_ID_DISTRITO);
...
CREATE OR REPLACE PROCEDURE FIDE_CLIENTES_TB_ACTUALIZAR_SP (
    ...
    V_ID_PAIS FIDE_CLIENTES_TB.ID_PAIS%TYPE,
    V_ID_PROVINCIA FIDE_CLIENTES_TB.ID_PROVINCIA%TYPE,
    V_ID_CANTON FIDE_CLIENTES_TB.ID_CANTON%TYPE,
    V_ID_DISTRITO FIDE_CLIENTES_TB.ID_DISTRITO%TYPE
)
AS
BEGIN
